...
#define HeapSetDebuggingInformation 0x80000002 // q; s: HEAP_DEBUGGING_INFORMATION
	...
	struct _ERESOURCE
	{
		_LIST_ENTRY SystemResourcesList;                                 //0x0
		_OWNER_ENTRY* OwnerTable;                                        //0x10
...
constexpr NTSTATUS StatusInfoLengthMismatch = 0xC0000004;
...
struct _GENERAL_LOOKASIDE
{
	union
	{
		_SLIST_HEADER ListHead;                                       //0x0
		_SINGLE_LIST_ENTRY SingleListHead;                           //0x0
	};
	USHORT Depth;                                                           //0x10
